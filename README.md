...
- sending the bot's `@handle` by itself in a group gives you 1 point, which is handy because Telegram does not let you tag yourself
...
- `/blessme`
- `@your_bot_handle` by itself in a group
- `/faaaah`
